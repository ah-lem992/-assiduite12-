                        ...
                        <h4 class="card-title ">
                            ...
                            <form action="{{ url('/seance') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ date('Y-m-d') }}" class="form-control" name="day"
            ...
            @section('scripts')
                <script>
                    ...
                    function populateDays(month) {
                        ...
                        // 31 or 30 days?
                        if (month === 'January' || month === 'March' || month === 'May' || month === 'July' || month ===
                            'August' || month === 'October' || month === 'December') {
                            dayNum = 31;
