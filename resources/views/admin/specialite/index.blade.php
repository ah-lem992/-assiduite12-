        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-primary">
                    ...
                    @endif
                    <h4 class="card-title  ">Les Specialités <a href="{{ url('specialite/create') }}"
                    ...
                    <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" type="get"
                        action="{{ url('/search_specialite') }}" method="GET">
                        {{ csrf_field() }}
                        <div class="form-group mb-0">
                            <div class="input-group input-group-alternative input-group-merge">
                                ...
                                <input class="form-control" name="search" placeholder="tapez spécialité " type="text">
                            </div>
                        </div>
                        ...
                        <body>
                            ...
                            @foreach ($specialites as $specialite)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $specialite->promo->annee }}</td>
                                    <td>{{ $specialite->specialite }}</td>


                                    <td>
                                        <a href="{{ url('specialite/' . $specialite->specialite_id) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable').on('click', '.deletebtn', function() {
                ...
                $('#delete-model_form').attr('action', '/specialite-delete/' + data[0]);
